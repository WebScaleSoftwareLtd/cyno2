...
export const allowedDropChannels = sqliteTable("allowed_drop_channels", {
...
export const lastGuildTakeout = sqliteTable("last_guild_takeout", {
    ...
    lastTakeout: integer("last_takeout", {mode: "timestamp"}),
});

export const levelBlacklistedChannels = sqliteTable("level_blacklisted_channels", {
    channelId: blob("channel_id", { mode: "bigint" }).primaryKey(),
    guildId: blob("guild_id", { mode: "bigint" }).notNull().references(() => guilds.guildId, {
        onDelete: "cascade",
    }),
...
export const currencyDrop = sqliteTable("currency_drop", {
...
export const levelRoles = sqliteTable("level_roles", {
...
export const roleShop = sqliteTable("role_shop", {
...
export const timelyCollections = sqliteTable("timely_collections", {
    userId: blob("user_id", { mode: "bigint" }).notNull(),
    guildId: blob("guild_id", { mode: "bigint" }).notNull().references(() => guilds.guildId, {
        onDelete: "cascade",
    }),
...
export const guildTimelyConfig = sqliteTable("guild_timely_config", {
    guildId: blob("guild_id", { mode: "bigint" }).primaryKey().references(() => guilds.guildId, {
        onDelete: "cascade",
    }),
...
export const dashboardAdmins = sqliteTable("dashboard_admins", {
...
export const guildBirthdayConfig = sqliteTable("guild_birthday_config", {
    guildId: blob("guild_id", { mode: "bigint" }).primaryKey().references(() => guilds.guildId, {
        onDelete: "cascade",
    }),
    roleId: blob("role_id", { mode: "bigint" }),
