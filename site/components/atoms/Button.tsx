...
const buttonStyles = {
    standard:
        "text-nowrap select-none bg-slate-100 dark:bg-gray-900 text-gray-900 dark:text-gray-200 p-3 rounded-lg hover:bg-slate-200 dark:hover:bg-gray-950 disabled:bg-gray-300 disabled:text-gray-400 disabled:dark:bg-gray-600 disabled:dark:text-gray-300",
