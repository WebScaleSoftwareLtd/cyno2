...
function GuildCard({
    ...
    return (
        <div className="w-full align-middle">
            <div className="dark:bg-gray-800 p-4 shadow-md dark:shadow-lg rounded-lg not-md:w-3/4">
                <p>
                    <img
                        src={
                            guildImage
                                ? `https://cdn.discordapp.com/icons/${guildId}/${guildImage}.png`
                ...
                <h4 className="text-md font-bold text-center mt-3 select-none">
                    {guildName}
                </h4>
